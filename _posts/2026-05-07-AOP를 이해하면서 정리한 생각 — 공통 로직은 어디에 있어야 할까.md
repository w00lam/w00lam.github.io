...
permalink: /posts/aop-common-logic/
---

## 들어가면서

최근 Filter, Interceptor를 보면서
...
Filter나 Interceptor는 요청 흐름을 다룬다.
...
Proxy를 이해하고 나니까
왜 Spring의 여러 기능들이
“메서드 호출 구조”에 의존하는지도 조금씩 잡혔다.

그리고 나서야
왜 Spring이 트랜잭션도 AOP 기반으로 처리하는지 조금 이해됐다.
...
그리고 AOP를 이해하면서
Spring이 왜 Proxy 기반으로 동작하는지 조금씩 눈에 들어왔다.
...
* [Filter / Interceptor / AOP 비교 글](/posts/filter-interceptor-aop/)
* [Spring Proxy 구조 정리 글](/posts/spring-proxy-core-logic/)
