...
제 GitHub Pages 블로그는 Jekyll과 Chirpy 테마로 하고 GitHub Actions로 자동 빌드·배포되도록 설정돼 있었습니다. 그런데 어느 날 워크플로우가 실패했다는 알림을 받았습니다. 에러 로그를 확인해보니 `sass-embedded (1.100.0) 설치 실패` 메시지가 눈에 띄었습니다.
