...
임베딩과 그래프는 데이터를 표현하는 방식도, 강점도 뚜렷이 다릅니다.
...
[^1]: 이전에 [AI 에이전트의 Harness(하네스)에 대한 기술적 고찰](/posts/deep-dive-into-ai-agent-harness/)에서 AI 에이전트의 안정적인 실행 환경의 중요성을 다룬 바 있습니다.
