...
permalink: /posts/spring-object-dependency/
---
...
| DTO | Data Transfer Object | 계층 간 데이터 전송을 위한 객체 | 배송용 박스 (전달만을 위해 최적화됨) |
...
이 결합을 끊으려면 **제어권을 외부로 넘겨야** 하고, 그것이 IoC의 핵심입니다.
...
### 개방-폐쇄 원칙(OCP)에서 얻은 것

> "확장에는 열려 있고 변경에는 닫혀 있어야 한다."

DI 구조를 쓰면 `UserDao` 코드는 그대로 두고 DB 연결 방식만 갈아 끼울 수 있습니다.
